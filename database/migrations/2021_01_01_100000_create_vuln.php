...
class CreateVuln extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $create_sql[] = <<<SQL
            CREATE TABLE IF NOT EXISTS public.k_vuln
                (
                    ...
                    CONSTRAINT k_vuln_pkey PRIMARY KEY (uid),
                    CONSTRAINT k_vuln_report_uid_fkey FOREIGN KEY (report_uid)
        ...
        $create_sql[] = <<<SQL
            CREATE INDEX IF NOT EXISTS k_vuln_image_uid
                ON public.k_vuln USING btree
                (image_uid COLLATE pg_catalog."default" ASC NULLS LAST)
                TABLESPACE pg_default;
        SQL;

        $create_sql[] = <<<SQL
            CREATE INDEX IF NOT EXISTS k_vuln_report_uid_fkey
                ON public.k_vuln USING btree
        ...
        $create_sql[] = <<<SQL
            CREATE INDEX IF NOT EXISTS k_vuln_vulnerability_id
                ON public.k_vuln USING btree
